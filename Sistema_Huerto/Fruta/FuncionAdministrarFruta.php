...
<body>
		<?php
			...
			echo "<hr />";
		?>
	<form action="./FuncionGestionFruta.php" method="POST" target="_self">		
		<?php
			switch($_POST['Gestion']){
				case "Agregar":
					...
					echo "<input type='text' name='Nombre' maxlength='30' required/><span>Nombre</span><br />";
					echo "<input type='number' name='Valor' min='1' max='22' required/><span>Valor</span>";
					break;
	...
	<br /><br /><a href="./AdministrarFruta.php" >Inicio</a>
</body>
